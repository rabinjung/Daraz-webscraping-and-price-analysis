1.  Selenium is used to scrape the samsung phone detail from Daraz and amazon and save in json file(Make sure to download chromedrive compatiable to your chrome before running the scraping code).
2.  
